...
<div class="container">
    <div class="card mt-3">
        ...
        <div class="card-body">
                        ...
                        <?php foreach ($products as $product): ?>
                            <tr>
                                ...
                                <td class="d-flex flex-wrap ps-md-2">
                                    ...
                                    <button class="deleteButton btn btn-link p-0 m-0" data-bs-toggle="modal"
                                            data-bs-target="#deleteConfirmationModal" data-id="<?= $product['id'] ?>">
            ...
            <?php else : ?>
                <p class="fs-6 mb-0">Ocurrió un error al conectarse a la base de datos. Por favor pongase en contacto
                    con el
                    administrador.</p>
            <?php endif; ?>
        </div>
